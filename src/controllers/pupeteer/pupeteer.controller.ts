...
import { pupetteerPdfService } from "../../services/pupeteer/pupeteer.service.js";

import { InvoiceItem, User } from "../../types/invoice.type.js";
export const pupeteerPdfController = async (req: Request, res: Response) => {
  try {
    // Validate query
    ...
    const pdf_buffer = await pupetteerPdfService({
